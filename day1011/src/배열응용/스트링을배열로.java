...
public class 스트링을배열로 {
	...
	public static void main(String[] args) {
		...
		String wt = sc.next();// (흐림,맑음,흐림,흐림,맑음,흐림,흐림,맑음,흐림,흐림,맑음,흐림)
		String[] wt2 = wt.split(",");
//		System.out.println(wt2[0]);
//		System.out.println(wt2[1]);
//		System.out.println(wt2[2]);
//		System.out.println(wt2.length);
